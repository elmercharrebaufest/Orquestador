...
{
    [TestFixture]
    class ProcesadorEjecutarCereoCabezalTest
    {
        private ProcesadorEjecutarCereoCabezal target;

        [SetUp]
        public void SetUp()
        {
            target = new ProcesadorEjecutarCereoCabezal(new NullLogger());
        }

        [Test]
        public void TestProcesarOK()
        {
            var comando = new EjecutarCereoCabezal { CodigoDispositivo = "BAL01" };
            ...
            driverMock.Setup(d => d.ForzarCero()).Returns(true);
        ...
        public void TestProcesarErrorEnDriverFormatoRespuesta()
        {
            ...
            var driverMock = new Mock<IDriverCabezal>();
            driverMock.Setup(d => d.ForzarCero()).Throws<FormatoRespuestaDriverException>();
        ...
        public void TestProcesarErrorEnDriverConexion()
        {
            ...
            var driverMock = new Mock<IDriverCabezal>();
            driverMock.Setup(d => d.ForzarCero()).Throws<ConexionDispositivoDriverException>();
        ...
        public void TestProcesarErrorEnDriverGenerico()
        {
            ...
            var driverMock = new Mock<IDriverCabezal>();
            driverMock.Setup(d => d.ForzarCero()).Throws<DriverException>();
        ...
        [Test]
        public void TestProcesarCabezalNoVuelveACero()
        {
            var comando = new EjecutarCereoCabezal { CodigoDispositivo = "BAL01" };
            var dispositivo = new Dispositivo
            {
            ...
            var driverMock = new Mock<IDriverCabezal>();
            driverMock.Setup(d => d.ForzarCero()).Returns(false);
            ...
            Assert.That(resultadoEjecutar.Mensaje.Codigo, Is.EqualTo(Codigos.CabezalNoFuerzaCero));
            Assert.That(resultadoEjecutar.Valores, Is.Empty);
        }
    }
}
