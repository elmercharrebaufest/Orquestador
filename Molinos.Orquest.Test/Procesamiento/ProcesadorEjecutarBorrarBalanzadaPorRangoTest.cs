...
{
    [TestFixture]
    class ProcesadorEjecutarBorrarBalanzadaPorRangoTest
    {
        private ProcesadorEjecutarBorrarBalanzadasPorRango target;
        private Mock<IDriverBalanzaPuerto> driverMock;

        [SetUp]
        public void SetUp()
        {
            target = new ProcesadorEjecutarBorrarBalanzadasPorRango(new NullLogger());
        ...
        {
            var comando = new EjecutarBorrarBalanzadasPorRango
            {
        ...
        public void TestErrorEnDriverConexion()
        {
            ...
            driverMock.Setup(d => d.BorrarBalanzadasPorRango(comando.IdBalanzadaInicio,comando.IdBalanzadaFin)).Throws<ConexionDispositivoDriverException>();
        ...
        public void TestProcesarErrorEnDriverGenerico()
        {
            ...
            driverMock.Setup(d => d.BorrarBalanzadasPorRango(comando.IdBalanzadaInicio, comando.IdBalanzadaFin)).Throws<DriverException>();
