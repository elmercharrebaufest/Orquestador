...
To include OpenALPR in your C/C++ application, include the alpr_c.h file in the include directory.  You must also link the libopenalpr.dll 
...
The AlprStream API organizes video streams so that they can be efficiently processed by OpenALPR. The library 
